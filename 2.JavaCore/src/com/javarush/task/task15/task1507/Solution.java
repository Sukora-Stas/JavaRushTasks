...
public class Solution {
    ...
    public static void printMatrix(int m, int n, String value) {
        ...
        printMatrix(m, (Integer) n, (Object) value);
        printMatrix((Integer) m, (Integer) n, value);
        printMatrix(m, (Integer) n, value);
        printMatrix((Integer) m, n, value);
        printMatrix(m, (Integer) n, value, m);
        printMatrix((Integer) m, (Integer) n, value, (Integer) m);
    ...
    public static void printMatrix(int m, Integer n, String value, int q) {
        for (int i = 0; i < m; i++) {
            for (int j = 0; j < n; j++) {
                System.out.print(value);
            }
    ...
    public static void printMatrix(Integer m, Integer n, String value, Integer q) {
        for (int i = 0; i < m; i++) {
            for (int j = 0; j < n; j++) {
                System.out.print(value);
            }
